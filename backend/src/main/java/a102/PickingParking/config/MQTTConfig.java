...
//
//            // 상대 경로를 절대 경로로 변환
//            String certPath = getResourcePath("certs/certificate.pem.crt");
//            String keyPath = getResourcePath("certs/private.pem.key");
//            String caPath = getResourcePath("certs/AmazonRootCA1.pem");
//
//            log.info("Loading certificates from: ");
//            log.info("Cert Path: {}", certPath);
//            log.info("Key Path: {}", keyPath);
//            log.info("CA Path: {}", caPath);
